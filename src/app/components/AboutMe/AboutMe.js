...
import { AboutDesc } from "@/app/data";
    ...
    <React.Fragment>
      ...
      >
        <div className="container m-auto">
          <h1 className="text-[240px] select-none w-[80%] overflow-hidden absolute lg:left-40 md:left-30 top-[-50px]  text-[#EAF7FC]">
            About Me
          </h1>
      ...
      <p
        key={index}
        className={`w-full lg:w-1/3 font-semibold text-[#223740c2] mr-0 mb-5 lg:mr-4 font-[200] ${hind.className}`}
      >
        {desc}
      </p>
    ))}
            ...
            <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mr-0 lg:mr-10">
              {AboutData.map((item, index) => (
                <a key={index}
                  ...
                  className={`relative cursor-pointer transition-all transform duration-300 group rounded-xl center p-6 lg:p-10 flex flex-col justify-center shadow-lg  items-center ${
                    selectedIndex == index
