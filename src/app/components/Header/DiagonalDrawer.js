    ...
    <React.Fragment>
      <div className="relative">
        ...
        <div
          ...
          } cursor-pointer fixed w-14 h-14 lg:w-16 lg:h-16 bg-[#48AFDE] top-0 flex justify-center items-center rounded-br-3xl `}
        >
          <div
      ...
      >
        <div className="relative">
          <div className="z-20 absolute transform-gpu ease-in-out duration-300 transition-all scale-100 opacity-100 bg-[#223740] bg-opacity-95 lg:w-[25%] p-6  h-screen top-0 flex flex-col sm:flex-row lg:flex-col items-center justify-center ">
            <nav className="text-white font-recoletaBold text-center text-2xl lg:text-4xl 2xl:text-4xl uppercase">
