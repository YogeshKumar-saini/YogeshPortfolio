    ...
    <React.Fragment>
      ...
      >
          ...
          <div className="relative">
            <div
            onClick={openDrawer}
            className="z-30 absolute cursor-pointer w-14 h-14 lg:w-16 lg:h-16 bg-[#48AFDE] flex justify-center items-center rounded-br-3xl">
        ...
        <nav className="invisible xl:visible xl:max-w-4xl 2xl:max-w-7xl mx-auto ">
           <ul className="flex font-recoletaBlack flex-row items-center h-16">
