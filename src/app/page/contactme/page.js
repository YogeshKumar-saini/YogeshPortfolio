          ...
          <div className="sm:flex gap-[20px] mt-[50px] max-w-[1105px] w-full h-full">
            <div className="flex flex-col flex-1 xl:flex-row gap-[20px]">
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Jaipur,rajasthan or</p>
                </div>
                <div>
                  <p className="text-[#666666]">vasai,Mumbai</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">Tel: +91 8209068126</p>
                </div>
                <div>
                  <p className="text-[#666666]">Tel: +91 8209068126</p>
                </div>
              ...
              >
                ...
                <div>
                  <p className="text-[#666666]">yksaini1090@gmail.com</p>
                </div>
                <div>
                  <p className="text-[#666666]">yksaini1090@gmail.com</p>
                </div>
