    ...
    <React.Fragment>
      ...
      <div className="relative">
        <Image
          src={data?.images[0]}
          alt="bg photo"
          className="h-[400px]  lg:mt-24  hover:grayscale sm:mt-0  object-fill"
          width={0}
          height={20}
          sizes="100vw"
      ...
      <div className="absolute z-30 lg:top top-[42px] sm:top-[200px] sm:left-[65px] justify-center items-center w-full px-10 sm:w-3/4 xl:w-1/2 sm:px-0 sm:text-left ">
        <div className="container m-auto">
          <div className="max-w-[650px] w-[100%] m-auto">
            <p className="opacity-3 sm:text-left text-center font-sans text-[#223740] mt-20 lg:mt-10 md:-mt-10"></p>
      ...
      <div
        className="grid  grid-cols-12  relative space-x-0 lg:space-x-8  lg:pt-20 pb-20"
        style={{
          background:
            "linear-gradient(90deg, rgba(238, 247, 251, 1) 58%, rgba(255, 255, 255, 1) 52%",
        }}
      >
        <div className="col-span-12  lg:col-span-8  scrol lg:px-0 sm:px-20">
          {data?.images.map((item) => (
            <div
              key={item}
              className="flex justify-center lg:justify-end px-2  items-center"
            >
              <Image
                src={item}
                ...
                height={100}
                width={800}
                className="mt-2 rounded-lg hover:grayscale"
              />
            </div>
          ))}
        </div>
        ...
        <div className="col-span-12 lg:col-span-4 lg:px-0 sm:px-20">
          <div className="mt-10 sm:mt-18 w-full lg:max-w-[300px] lg:px-1 px-3 sticky top-36 pb-14">
            ...
            <p className="text-[16px] font-semibold text-[#223740] mt-4 mb-2">
              Tech Stack:
            </p>
            <div className="flex flex-wrap">
              {data?.techStack?.map((tech, index) => (
                <h1
                  key={index}
                  className="mr-3 text-[14px] bg-[#63c5f1] lg:bg-[#EEF7FB] px-2 py-1 rounded-xl font-sans mb-3 text-white lg:text-[#6A787D]"
                >
                  {tech}
                </h1>
              ))}
